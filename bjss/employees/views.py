...
def ask_chatgpt(request, project):
    ...
    # Filter employees using filter_actual_employees function
    employees = filter_actual_employees(project)
    ...
    try:
        openai.api_key = "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"
