from .views import index, employees_list_view, filtered_employees_list_view,ask_chatgpt, create_employee, get_preferred_team, get_ideal_team, get_actual_team
from django.urls import path

urlpatterns = [
    path('', index, name='index'),
    path('employees/', employees_list_view, name='employees-list'),
